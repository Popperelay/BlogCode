...
int main() {
	...
	while (!glfwWindowShouldClose(window)) {
		...
		glUniform3f(glGetUniformLocation(lightObject.shaderProgram, "light.lightAxis"), mycamera.cameraFront.x, mycamera.cameraFront.y, mycamera.cameraFront.z);
		glUniform1f(glGetUniformLocation(lightObject.shaderProgram, "light.inCutOff"), cos(radians(12.5f)));
