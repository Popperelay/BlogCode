...
int main() {
	...
	//定义自定义着色器类shader的对象
	shader grass_shader("GrassVS.glsl", "GrassFS.glsl");
	...
	while (!glfwWindowShouldClose(window)) {
		...
		glUniformMatrix4fv(glGetUniformLocation(grass_shader.shaderProgram, "view"), 1, GL_FALSE, value_ptr(view));
		glUniformMatrix4fv(glGetUniformLocation(grass_shader.shaderProgram, "projection"), 1, GL_FALSE, value_ptr(projection));
