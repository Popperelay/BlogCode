...
int main() {
	...
	shader normalDisplay("DisplayNormalVS.glsl", "DisplayNormalFS.glsl", "DisplayNormalGS.glsl");
	...
	while (!glfwWindowShouldClose(window)) {
		...
		normalDisplay.Use();
		glUniformMatrix4fv(glGetUniformLocation(normalDisplay.shaderProgram, "view"), 1, GL_FALSE, value_ptr(view));
		glUniformMatrix4fv(glGetUniformLocation(normalDisplay.shaderProgram, "projection"), 1, GL_FALSE, value_ptr(projection));
		glUniformMatrix4fv(glGetUniformLocation(normalDisplay.shaderProgram, "model"), 1, GL_FALSE, value_ptr(model));
